...
type Props = {
  profile: PunkProfileVc | DaoProfileVc;
  type: string;
}

const isProfilePunk = (profile: DaemonVc, type: string): profile is PunkProfileVc => type === Objects.Punk;

const ProfileContainer: FC<Props> = ({ profile, type }) => {
